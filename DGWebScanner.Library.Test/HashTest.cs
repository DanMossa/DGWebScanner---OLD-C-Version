...
namespace DGWebScanner.Library.Test
{
    ...
    class HashTest
    {
        ...
        [Test]
        public void Return5555Given5555Anything([Values("5555018f5ec415a0c929f7c07ae40b9a", "5555025dd61bd8192c8047cd321059ae")] string input)
        {
        ...
        [Test]
        public void Return0Given4Chars_HashKiller([Values("http://hash-killer.com/dict/a/s/d/a", "http://hash-killer.com/dict/1/2/3/4")] string inputUrl,
        ...
        [Test]
        public void ReturnDecodedGivenWrongHash_Nitrxgen([Values("6e2f0a1d", "666602426340d91b6ba53e0667cc151d")] string inputHash)
        {
